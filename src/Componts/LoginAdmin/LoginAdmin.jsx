  ...
  return (
      <>
         ...
         <div className='flex justify-center items-center min-h-screen ss relative'>
           <div className='absolute top-2  w-36  md:left-3 '>
             <img src={logo} alt="" className='mx-auto' />
           </div>
           <div className='  relative w-117.5 h-140.25 shadow-2xl from-[rgba(74,144,194,0.85)] to-[rgba(230,220,203,0.8)] backdrop-blur-xl  rounded-2xl border-white border-2 p-8 mt-25'>
             <FaArrowLeft className='text-2xl cursor-pointer ' />
             <div className='flex justify-center items-center flex-col '>
               <div className='w-20 rounded-4xl'>
                 <img src={logoUni} alt="" className='bg-white mt-5 border-white rounded-full object-cover' />
               </div>
               <h2 className='text-2xl font-semibold py-3'>Student Service Gateway</h2>
               <p className='font-semibold text-[20px] pb-6'>Tanta University</p>
             </div>
             <form className="max-w-sm mx-auto">
               <div className="mb-5 ms-9 ">
             ...
             <p className=' flex items-center justify-center text-[#FF5047] gap-1.5 text-[20px] font-semibold'><SiSpringsecurity /> Privacy Policy and Data Security</p>
           </div>
         </div>
